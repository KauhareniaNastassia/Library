...
import {BookType} from './books-reducer';
...
const initialState: InitialCategoryStateType = {
    ...
    ] as unknown as GenreBarItemType[]
}


export const categoryReducer = (state: InitialCategoryStateType = initialState): InitialCategoryStateType => state
...
type InitialCategoryStateType = {
    items: GenreBarItemType[]
}

export type GenreBarItemType = {
    genreId: number,
    category: string,
    name: string,
    content: BookType[]
